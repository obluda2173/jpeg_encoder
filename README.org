...
- [[file:./data/input/test_1.jpg][test_1.jpg]]

- [[file:./data/output/test_1_compressed.jpg][test_1_compressed.jpg]]
  (only works with gray images)

* Important!
Note that this is a naive JPEG encoder. Thus it is not optimised, which you can notice in the size of compressed file being greater than size of original file. The goal of this project was again to deepen my understanding of DCT, at which I succeeded.

Though size of compressed file is greater, the actuall DCT implementation is fully correct and working.
